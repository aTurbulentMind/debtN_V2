...
<div id="affiliates" class="head_Line">
	<h3>Affiliates</h3>
</div>
...
<div class="grid">
	<div class="card">
		<svg><Phone_icon /></svg>
		<h2 class="card-title">Collection Comp 1</h2>
	</div>

	<div class="card">
		<svg><Mail_Svg /></svg>
		<h2 class="card-title">Collection Comp 2</h2>
	</div>

	<div class="card">
		<svg><Support_Svg /></svg>
		<h2 class="card-title">Collection Comp 3</h2>
	</div>

	<div class="card">
		<svg><Doc_Svg /></svg>
		<h2 class="card-title">Collection Comp 4</h2>
	</div>
